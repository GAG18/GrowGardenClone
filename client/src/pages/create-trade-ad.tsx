...
import { X, Plus, Search, ArrowUp, ArrowDown, RotateCcw, Save, Send, Sprout, Crown, Package, Minus } from "lucide-react";
          ...
          <DialogContent className="bg-gray-900 border-gray-700 text-white max-w-lg w-full max-h-[90vh] overflow-y-auto">
            ...
            {selectedItemForCustomization && (
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4 p-4 bg-gray-800 rounded-lg">
                  <div className="w-16 h-16 flex items-center justify-center bg-gradient-to-br from-purple-500 to-blue-500 rounded-lg">
                    {selectedItemForCustomization.imageUrl ? (
                      ...
                      selectedItemForCustomization.type === 'Pet' ? (
                ...
                {isPetItem(selectedItemForCustomization.name) && (
                ...
                {(isPetItem(selectedItemForCustomization.name) || isCropItem(selectedItemForCustomization.name)) && (
                  <div className="space-y-3">
                    <div className="flex items-center gap-2">
                ...
                {isCropItem(selectedItemForCustomization.name) && (
                  <div className="space-y-3">
                    <div className="flex items-center gap-2">
